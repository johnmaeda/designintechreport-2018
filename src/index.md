...
class: slide--document slide--darkgray layout-chapter sans
...
class: slide--document slide--kinds-of-design in-progress
...
.group[
.darkgray[
### The top 10 most critical issues and challenges currently facing design
]
...
.x-medium.quote[
> average mobile web page load time on a 3G connection
...
.x-medium.quote[
> abandon site that takes longer than 3 seconds to load on mobile
...
.x-medium.quote[
> JPEGs using a new open source encoder called Guetzli
...
.x-medium.quote[
or less constitute more than half of all smartphone sessions
